@props(['icon', 'class' => 'w-6 h-6 inline-block', 'width' => '24'])

@switch($icon)
    @case('squares-2x2-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $class }}" style="width: {{ $width }}">
    ...
    @case('arrow-down-on-square-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $class }}" style="width: {{ $width }}">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @case('clipboard-document-check-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $class }}" style="width: {{ $width }}">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @case('arrow-up-on-square-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $class }}" style="width: {{ $width }}">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
    ...
    @case('chat-bubble-oval-left-ellipsis-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}"
            style="width: {{ $width }}">
            <path fill-rule="evenodd"
    ...
    @case('document-magnifying-glass-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}"
            style="width: {{ $width }}">
